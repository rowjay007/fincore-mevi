...
const (
	NotificationService_SendNotification_FullMethodName      = "/fincore.notification.v1.NotificationService/SendNotification"
	NotificationService_GetNotificationStatus_FullMethodName = "/fincore.notification.v1.NotificationService/GetNotificationStatus"
)
...
type NotificationServiceClient interface {
	// Send a direct notification (bypass async queue for high priority)
	SendNotification(ctx context.Context, in *SendNotificationRequest, opts ...grpc.CallOption) (*SendNotificationResponse, error)
	// Get status of a notification delivery
...
var NotificationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "fincore.notification.v1.NotificationService",
